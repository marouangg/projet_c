...
namespace WindowsFormsApp1
{
    public partial class DiagnosticForm : Form
    {
        ...
        {
            e.Graphics.DrawString(label3.Text + PatientNamelbl.Text + Diagnosislbl.Text + SymptomsLbl.Text + Medicineslbl.Text, new Font("century Gothic", 25, FontStyle.Bold), Brushes.Black, new Point(230,150));
            e.Graphics.DrawString(label3.Text + PatientNamelbl.Text +"\n"+ Diagnosislbl.Text + "\n" + SymptomsLbl.Text + "\n" + Medicineslbl.Text+"\n" , new Font("century Gothic", 12, FontStyle.Regular), Brushes.Black, new Point(230,500));
        }
